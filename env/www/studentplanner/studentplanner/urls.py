...
urlpatterns = patterns('',
	...
	url(r'^signup_user/$', TemplateView.as_view(template_name="signup_user.html"), name="usersignup"),
	url(r'^signup_org/$', TemplateView.as_view(template_name="signup_org.html"), name="orgsignup"),
